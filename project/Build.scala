...
object lightningtimerBuild  extends Build {

  lazy val basicSettings = seq(
    version               := "1.0.0",
    organization          := "uk.co.bruntonspall.lightningtimer",
    description           := "",
    scalaVersion          := "2.9.1",
  ...
  lazy val root = Project(id="lightningtimer", base=file("."))
    .settings(
    ...
    .settings(
      Twirl.twirlImports := Seq("uk.co.bruntonspall.lightningtimer.model._")
    )
}
